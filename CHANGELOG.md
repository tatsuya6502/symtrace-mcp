...
- Structured JSONL logging to `.symtrace/logs/` via tracing ecosystem (per-invocation files, configurable log level, 7-day cleanup) (#20)
...
[Unreleased]: https://github.com/tatsuya6502/symtrace-mcp/compare/v0.5.1...HEAD
